...
# golbal variables
api_key = 'RGAPI-d397e4f9-1c16-410d-b74b-37e8357a99a6'
    ...
    try:
        ...
        for i in range(0,len(match_detail['info']['frames'])):
            ...
            for x in range(0, len(match_detail['info']['frames'][i]['events'])):
                ...
                champ_kills['frame'] = i
                skill_level_ups['frame'] = i
                item_destroyed['frame'] = i
                item_purchased['frame'] = i
                level_ups['frame'] = i
                building_kills['frame'] = i
                turret_plates['frame'] = i
                ward_placed['frame'] = i
                ward_kill['frame'] = i
                item_undo['frame'] = i
                elite_monster['frame'] = i                                                           
          ...
          print('error')
        #if cur_time + pd.DateOffset(seconds=300) <= datetime.now():
        #    print('sleeping')
        #    time.sleep(30)
        #    cur_time = datetime.now()
